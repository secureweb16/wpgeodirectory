...
?>
	<div
		class="row row-cols-1 row-cols-sm-2 geodir-category-list-view 33333333333333333333333 <?php echo apply_filters( 'geodir_listing_listview_ul_extra_class', '', 'widget' ); ?>">
