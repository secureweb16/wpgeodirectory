<div id="container_general" class="clearfix">
	...
	<input type="hidden" name="listing_type" id="gd_new_post_type" value="<?php echo esc_attr( self::$post_type );?>"/>
	<input type="hidden" name="manage_field_type" class="manage_field_type" value="<?php echo esc_attr( self::$sub_tab ); ?>" />
